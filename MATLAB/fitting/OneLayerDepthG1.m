...
function [fitting_data, anglesforfit] =  OneLayer2Dall(alpha, gaussiannum, bounce)
%close all
%clear
%clc
...
function [x, y, z, angle] = read_data(datadir, alpha, mirror, bounce)
        close all
        cd(datadir)
        prefix = '3d_output';
