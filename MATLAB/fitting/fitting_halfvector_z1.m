function [obj, W, M, R, isigma ] = fitting_halfvector_z1(dir,fundir,alpha,angle,input,...
...
for j = 1:length(gaussiannumvec)
    ...
    if accelerated
        ...
        addpath(aemdir);
        [obj, W, M, R, isigma] = accelerated_em(train,trainnum,numGaussian,maxiter,tol, softinit, W, M, R);
    else
